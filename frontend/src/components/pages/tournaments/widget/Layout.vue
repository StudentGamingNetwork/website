...
import SSignUp from "@/components/pages/tournaments/widget/SignUp.vue";
import STournamentWidget from "@/components/pages/tournaments/widget/Tournament.vue";
import STeamCard from "@/components/pages/tournaments/widget/TeamCard.vue";
