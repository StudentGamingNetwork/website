    ...
    server.post<{ Body: TSchemaRequest; Params: TSchemaParams; Response: TSchemaResponse }>(
        ...
        async (request, reply) => {
            ...
            if (!isUndefined(request.body.name)) {
                ...
                tournament.settings.toornament = request.body.settings?.toornament || "";
                ...
                tournament.game.team.coachEnabled = request.body.game?.team.coachEnabled;
                tournament.game.team.managerEnabled = request.body.game?.team.managerEnabled;
